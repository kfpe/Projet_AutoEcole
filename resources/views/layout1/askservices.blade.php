        ...
        <form id="serviceForm" class="service-form">
            <div id="step1">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="serviceType" onchange="updateServiceFields()" required>
    ...
    switch(serviceType) {
        case 'formation':
            fieldsHTML = `<div class="form-group">
                ...
                <input type="text" class="form-control" id="drivingExperience" required>
            </div>
            <div class="form-group">
        ...
        case 'chauffeurs':
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="jobDuration" required>
            </div>`;
            break;
        default:
            fieldsHTML = '';
