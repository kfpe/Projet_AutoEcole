<?php
// Variables dynamiques (remplacez par vos données réelles)
...
$nbAgences = 12; // Remplacer par une requête pour compter les agences
$nbAdmins = 5; // Remplacer par une requête pour compter les administrateurs
?>
...
<body>
    ...
    <div class="sidebar d-flex flex-column p-3" id="sidebar">
        ...
        <ul class="nav nav-pills flex-column">
            <li><a href="#" class="nav-link active" data-url="{{ route('superAdmin') }}"><i class="bi bi-speedometer2 me-2"></i><span>Dashboard</span></a></li>
            <li><a href="#" class="nav-link" data-url="{{ route('agences.index') }}"><i class="bi bi-building me-2"></i><span>Agences</span></a></li>
            <li><a href="#" class="nav-link" data-url="{{ route('administrateurs.index') }}"><i class="bi bi-person-gear me-2"></i><span>Administrateurs</span></a></li>
            <li><a href="#" class="nav-link" data-url="#"><i class="bi bi-gear me-2"></i><span>Paramètres</span></a></li>
        </ul>
    </div>
